...
import { Thumb as SwitchPrimitiveThumb, Root as SwitchPrimitiveRoot } from '@radix-ui/react-switch';
import { styled, VariantProps, CSS } from '../../../stitches.config';

const StyledThumb = styled(SwitchPrimitiveThumb, {
  position: 'absolute',
  left: 0,
  width: 13,
  height: 13,
...
const StyledSwitch = styled(SwitchPrimitiveRoot, {
  all: 'unset',
...
type SwitchRef = ElementRef<typeof StyledSwitch>;
type SwitchVariants = VariantProps<typeof StyledSwitch>;
type ISwitchPrimitiveProps = ComponentProps<typeof SwitchPrimitiveRoot>;
